...
NXT.prototype.rampupMotorA = function (callback) {
    if (this.serialPort == null) {
        debug('unable to rampupMotorA, NXT is not connected');
        return;
    }

    nxtlib.setOutputState(this.serialPort, {
        port: nxtlib.ports.MOTOR_A,
        runState: nxtlib.runStates.RAMPUP
    }, function () {
        utils.doCallback(callback);
    });
};
...
NXT.prototype.startMotorA = function (callback) {
    if (this.serialPort == null) {
        debug('unable to startMotorA, NXT is not connected');
        return;
    }
...
NXT.prototype.stopMotorA = function (callback) {
    if (this.serialPort == null) {
        debug('unable to stopMotorA, NXT is not connected');
        return;
    }
